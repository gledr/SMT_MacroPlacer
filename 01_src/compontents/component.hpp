...
public: 
    ...
    std::string _get_lx(eOrientation const orientation);
    std::string _get_ly(eOrientation const orientation);
    std::string _get_ux(eOrientation const orientation);
    std::string _get_uy(eOrientation const orientation);
